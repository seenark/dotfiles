...
<!-- For checkpoint task examples and patterns, see @$HOME/.config/kilo/get-shit-done/references/checkpoints.md -->
...
See `$HOME/.config/kilo/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `$HOME/.config/kilo/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `$HOME/.config/kilo/get-shit-done/workflows/verify-phase.md` for verification logic.
