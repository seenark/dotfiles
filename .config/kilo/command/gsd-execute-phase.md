...
<execution_context>
@$HOME/.config/kilo/get-shit-done/workflows/execute-phase.md
...
<process>
Execute the execute-phase workflow from @$HOME/.config/kilo/get-shit-done/workflows/execute-phase.md end-to-end.
