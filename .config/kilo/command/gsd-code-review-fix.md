...
<execution_context>
@$HOME/.config/kilo/get-shit-done/workflows/code-review-fix.md
</execution_context>
...
Execute the code-review-fix workflow from @$HOME/.config/kilo/get-shit-done/workflows/code-review-fix.md end-to-end.
