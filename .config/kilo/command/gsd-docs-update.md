...
<execution_context>
@$HOME/.config/kilo/get-shit-done/workflows/docs-update.md
</execution_context>
...
<process>
Execute the docs-update workflow from @$HOME/.config/kilo/get-shit-done/workflows/docs-update.md end-to-end.
