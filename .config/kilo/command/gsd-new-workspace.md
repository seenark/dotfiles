...
<execution_context>
@$HOME/.config/kilo/get-shit-done/workflows/new-workspace.md
@$HOME/.config/kilo/get-shit-done/references/ui-brand.md
</execution_context>

<process>
Execute the new-workspace workflow from @$HOME/.config/kilo/get-shit-done/workflows/new-workspace.md end-to-end.
