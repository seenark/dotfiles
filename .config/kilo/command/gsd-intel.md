...
Intel system is disabled. To activate:
  ...
  node $HOME/.config/kilo/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node $HOME/.config/kilo/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node $HOME/.config/kilo/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node $HOME/.config/kilo/get-shit-done/bin/gsd-tools.cjs intel diff
```
...
Project root: ${CWD}
gsd-tools path: $HOME/.config/kilo/get-shit-done/bin/gsd-tools.cjs
