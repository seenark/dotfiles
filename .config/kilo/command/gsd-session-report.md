...
<execution_context>
@$HOME/.config/kilo/get-shit-done/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @$HOME/.config/kilo/get-shit-done/workflows/session-report.md end-to-end.
</process>
