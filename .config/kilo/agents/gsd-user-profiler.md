...
<reference>
@$HOME/.config/kilo/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `$HOME/.config/kilo/get-shit-done/references/user-profiling.md` to load:
