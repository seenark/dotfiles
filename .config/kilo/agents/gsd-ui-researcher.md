...
Use template from `$HOME/.config/kilo/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `$HOME/.config/kilo/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "$HOME/.config/kilo/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
