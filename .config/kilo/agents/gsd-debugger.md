...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = $HOME/.config/kilo
                  → checks $HOME/.config/kilo/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = $HOME/.config/kilo/get-shit-done
                  → writes to $HOME/.config/kilo/get-shit-done/hooks/
...
@$HOME/.config/kilo/get-shit-done/references/thinking-models-debug.md
...
- Read @$HOME/.config/kilo/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "$HOME/.config/kilo/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "$HOME/.config/kilo/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "$HOME/.config/kilo/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
